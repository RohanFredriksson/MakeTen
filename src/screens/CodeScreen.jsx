    ...
    <View style={[styles.container, {backgroundColor: '#3A3B4A'}]}>
      ...
      <View style={[styles.shadow, {backgroundColor: theme.background, paddingVertical: 0.017772511845 * height, paddingHorizontal: 0.03554502369 * height, borderRadius: 0.02369668246 * height, position: 'absolute', transform: [{translateY: 4.125 * 0.09478672985 * height}]}]}>
        <View style={[styles.container, {flexDirection: 'row', width: 0.3317535545 * height}]}>
          <TouchableWithoutFeedback onPress={() => {props.left();}}><Image source={require('./../assets/icons/camera.png')} width={0.04739336492 * height} height={0.04739336492 * height} style={{width: 0.04739336492 * height, height: 0.04739336492 * height, paddingHorizontal: 0.02369668246 * height, tintColor: theme.paragraph}}/></TouchableWithoutFeedback>
          <View style={{marginHorizontal: 0.02369668246 * height, backgroundColor: theme.paragraph, width: 2, height: 0.04739336492 * height}}/>
          <Image source={require('./../assets/icons/house-chimney.png')} width={0.04739336492 * height} height={0.04739336492 * height} style={{width: 0.04739336492 * height, height: 0.04739336492 * height, paddingHorizontal: 0.02369668246 * height, tintColor: theme.title}}/>
          <View style={{marginHorizontal: 0.02369668246 * height, backgroundColor: theme.paragraph, width: 2, height: 0.04739336492 * height}}/>
          <TouchableWithoutFeedback onPress={() => {props.right();}}><Image source={require('./../assets/icons/settings.png')} width={0.04739336492 * height} height={0.04739336492 * height} style={{width: 0.04739336492 * height, height: 0.04739336492 * height, paddingHorizontal: 0.02369668246 * height, tintColor: theme.paragraph}}/></TouchableWithoutFeedback>
        </View>
      </View>
